...
| --- | --- | --- | --- |
| Material selection | `renderMaterialGrid` in `public/js/materials.js` | Native buttons with pressed state; three columns; hidden and cleared for Condition items; nullable for other groups | Desktop and 390px browser workflow |
